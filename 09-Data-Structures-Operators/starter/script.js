...
const priceUS = '288,976$';
const pricePK = priceUS.replace('$', 'Pkr');
console.log(priceUS.replace(/8/g, '.')); // Making it global
const pricePK2 = priceUS.replaceAll('8', 'Eight');
console.log(pricePK2);
...
console.log('My_Name_is_Muhammad_Zeshan_Tahir'.split('_'));
...
let message = '-_-';
message = message.padStart(9, '(');
message = message.padEnd(15, ')');
message += '\n';
console.log(message);

const maskCard = function (number) {
  leftover = number.slice(-4);
  number = leftover.padStart(number.length, '*');
  return number;
};

console.log(maskCard('12312413532523'));
console.log(maskCard('1232213'));
