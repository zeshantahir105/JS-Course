...
const controlSearchResults = async function() {
    try {
        ...
        // 1. Get search query
        const query = await (0, _searchViewDefault.default).getQuery();
        if (!query) return;
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView":"9OQAM","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq"}],"49tUX":[function(require,module,exports) {
...
const loadRecipe = async function(id) {
    try {
        const url = `${(0, _configJs.API_URL)}get?rId=${id}`;
...
const loadSearchResults = async function(query) {
    try {
        const url = `${(0, _configJs.API_URL)}/search?q=${query}`;
        const data = await (0, _helpersJs.getJSON)(url);
        // console.log(data);
...
},{"regenerator-runtime":"dXNgZ","./config.js":"k5Hzs","./helpers.js":"hGI1E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config":"k5Hzs","./views/resultsView.js":"cSbZE","./views/recipeView.js":"l60JC"}],"dXNgZ":[function(require,module,exports) {
/**
...
},{"./view.js":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp"}],"bWlJ9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class View {
    ...
    render(data, render = true) {
        // console.log(data);
        if (!data || Array.isArray(data) && data.length === 0) // console.log('Here');
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp","./resultsView":"cSbZE","timers/promises":"jhUEF"}],"loVOp":[function(require,module,exports) {
...
},{"url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view.js":"bWlJ9"}],"9OQAM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _resultsViewJs = require("../views/resultsView.js");
var _resultsViewJsDefault = parcelHelpers.interopDefault(_resultsViewJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../views/resultsView.js":"cSbZE"}],"6z7bi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view.js":"bWlJ9","url:../../img/icons.svg":"loVOp"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire3a11")
