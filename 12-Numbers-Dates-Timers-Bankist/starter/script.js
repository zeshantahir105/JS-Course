...
// Checking that the value is a number or not
...
console.log(25 ** (1 / 2));
console.log(Math.max(5, 2, 5, 6, 67, 2));
console.log(Math.min(1231, 2, 312, 3, 123, 1, 23, 123, 2));

console.log((2.12323127).toFixed(2));
console.log(+(2.1333323127).toFixed(2));
